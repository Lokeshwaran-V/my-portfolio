      ...
      <div className="skills__container">
        <div className="skills__left">
          ...
          <div className="skills__description">
            ...
            <p data-aos="fade-right" data-aos-duration="500" data-aos-delay="1300">
            ...
            <div className="skills__progress">
              <div className="skills__progress-item" data-aos="fade-right" data-aos-duration="500" data-aos-delay="2000">
                <img src={REDUX} alt="Redux" />
                <progress value={80} max={100}></progress>
              </div>
              <div className="skills__progress-item" data-aos="fade-right" data-aos-duration="500" data-aos-delay="1650">
                <img src={TAILWIND} alt="Tailwind" />
                <progress value={60} max={100}></progress>
              </div>
            </div>

            <p data-aos="fade-right" data-aos-duration="500" data-aos-delay="2300">
        ...
        <div className="skills__right">
          <div className="skills__logos">
            <ul className="skills__logos-list">
              <li className="skills__logo-item" data-aos="fade-up" data-aos-duration="1500">
                <img src={HTML} alt="HTML" />
                <p>HTML</p>
              </li>
              <li className="skills__logo-item" data-aos="fade-up" data-aos-duration="1500">
              ...
              <li className="skills__logo-item" data-aos="fade-down" data-aos-duration="1500">
                <img src={REDUX} alt="Redux" />
                <p>Redux</p>
              </li>
              <li className="skills__logo-item" data-aos="fade-down" data-aos-duration="1500">
